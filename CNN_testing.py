...
from variable_models.tomato_seg import classes, npy_directory, test_img_data_name, test_labels_data_name, weights_directory, best_weight, shape, n_categories, loss_parameter, title, tune
...
def main():
    ...
    print(title + " - model accuracy: {:.2f}%".format(final_model_acc * 100))
